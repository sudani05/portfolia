  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'smit.sudani@email.com',
      link: 'mailto:smit.sudani@email.com'
    },
    {
      icon: Phone,
      label: 'Phone',
  ...
  const socialLinks = [
    {
      icon: Github,
      label: 'GitHub',
      url: 'https://github.com/smitsudani',
      color: 'hover:text-gray-400'
    },
    {
      icon: Linkedin,
      label: 'LinkedIn',
      url: 'https://linkedin.com/in/smitsudani',
      color: 'hover:text-blue-400'
    },
    {
      icon: ExternalLink,
      label: 'Portfolio',
      url: 'https://smitsudani.com',
          ...
          >
            <div>
              ...
              <p className="text-gray-300 mb-8 leading-relaxed">
                I'm always open to discussing new opportunities, interesting projects, or just having a chat about technology and data science. Feel free to reach out!
              </p>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className={`p-3 bg-gray-800/50 rounded-full border border-gray-700/50 hover:border-cyan-400/50 transition-all duration-300 text-gray-400 ${social.color}`}
                  >
                    <social.icon size={20} />
                  </motion.a>
                ))}
